...
class AlanVoice {
  ...
  ///
  /// Returns true if Alan Button wake word is enabled
  /// False otherwise
  ///
  static Future<bool> getWakewordEnabled() async {
    return await _channel.invokeMethod('getWakewordEnabled');
  }

  ///
  /// Set Alan Button wake word enabled/disabled
  ///
  static void setWakewordEnabled(bool enabled) async {
    _channel.invokeMethod('setWakewordEnabled',<String, dynamic>{ "wakeword_enabled": enabled } );
  }
